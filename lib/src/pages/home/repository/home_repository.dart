...
class HomeRepository {
  ...
  Future<HomeResult<CategoryModel>> getAllProducts() async {
    final result = await _httpManager.restRequest(url: Endpoints.getAllProducts, method: HttpMethods.post, body: {});
